...
public class DialogHelper extends DialogFragment {
    ...
    //parentId：Due to force majeure, such as horizontal and vertical screen switching, split screen, folding screen switching, etc. may cause the DialogFragment to restart. In order to ensure the normal operation of the function after restarting, you need to save the ID of your own (BaseDialog) to facilitate rebinding to BaseDialog
    @Override
