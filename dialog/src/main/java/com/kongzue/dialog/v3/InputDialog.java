...
public class InputDialog extends MessageDialog {
    ...
    public static InputDialog build(@NonNull AppCompatActivity context) {
        synchronized (InputDialog.class) {
            ...
            inputDialog.log("Loading dialog:" + inputDialog.toString());
    ...
    public OnDialogButtonClickListener getOnOkButtonClickListener() {
        error("please use getOnInputOkButtonClickListener() Obtain onOkButtonClickListener");
        return null;
    }
    ...
    public OnDialogButtonClickListener getOnCancelButtonClickListener() {
        error("please use getOnInputCancelButtonClickListener() 获取 onCancelButtonClickListener");
        return null;
    }
    ...
    public OnDialogButtonClickListener getOnOtherButtonClickListener() {
        error("please use getOnInputOtherButtonClickListener() Obtain onOtherButtonClickListener");
        return null;
    }
    ...
    public InputDialog setStyle(DialogSettings.STYLE style) {
        if (isAlreadyShown) {
            error("You must use the build(...) method to create setStyle(...) to modify the dialog theme or style.");
            return this;
        }
