...
public class BottomMenu extends BaseDialog {
    ...
    private BaseAdapter customAdapter;      //Allow users to customize the Adapter of Menu
    ...
    public static BottomMenu build(@NonNull AppCompatActivity context) {
        synchronized (BottomMenu.class) {
            ...
            bottomMenu.log("Load the bottom menu: " + bottomMenu.toString());
    ...
    public void bindView(View rootView) {
        log("Launch the bottom menu -> " + toString());
        ...
        switch (style) {
            ...
            case STYLE_KONGZUE:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    //Set the bottom navigation bar button dark, invalid, the reward is resolved ————
