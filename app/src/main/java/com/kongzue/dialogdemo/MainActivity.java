...
public class MainActivity extends BaseActivity {
    ...
    //Demonstrate login full screen dialog
    OnDialogButtonClickListener nextStepListener = new OnDialogButtonClickListener() {
        ...
        public boolean onClick(BaseDialog baseDialog, View v) {
            if (isNull(editUserName.getText().toString().trim())) {
                TipDialog.show(me, "please enter account", TipDialog.TYPE.WARNING);
                return true;
            }
            ...
            ((FullScreenDialog) baseDialog).setCancelButton("Previous", new OnDialogButtonClickListener() {
                @Override
                public boolean onClick(BaseDialog baseDialog, View v) {
                    ...
                    ((FullScreenDialog) baseDialog).setCancelButton("cancel", null);
                    ((FullScreenDialog) baseDialog).setOkButton("Next step", nextStepListener);
                    
                    return true;
                }
            });
            ((FullScreenDialog) baseDialog).setOkButton("log in", new OnDialogButtonClickListener() {
                @Override
                public boolean onClick(BaseDialog baseDialog, View v) {
                    if (isNull(editPassword.getText().toString().trim())) {
                        TipDialog.show(me, "Please enter the password", TipDialog.TYPE.WARNING);
                        return true;
                    }
                    WaitDialog.show(me, "logging in...");
                    runOnMainDelayed(new Runnable() {
                        @Override
                        public void run() {
                            TipDialog.show(me, "wrong password", TipDialog.TYPE.WARNING);
                        }
                    }, 2000);
                    return true;
                }
    ...
    public void setEvents() {
        ...
        btnFullScreenDialogLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FullScreenDialog
                        ...
                        .setOkButton("Next step", nextStepListener)
        ...
        btnFullScreenDialogWebPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                }).setOkButton("shut down", new OnDialogButtonClickListener() {
                    @Override
                    public boolean onClick(BaseDialog baseDialog, View v) {
                        return false;
                    }
        ...
        //Custom content layout-dialog
        btnCustomMessageDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MessageDialog.show(me, "prompt", "This window comes with a custom layout", "understood")
                        .setCustomView(R.layout.layout_custom, new MessageDialog.OnBindView() {
                            @Override
                            public void onBind(MessageDialog dialog, View v) {
                                //Binding layout events
                                v.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        toast("Clicked a custom layout");
                                    }
                                });
                            }
                        });
        ...
        //Custom content layout-input box
        btnCustomInputDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                InputDialog.show(me, "prompt", "This window comes with a custom layout", "understood")
...
//                        .show();
        ...
        //Custom content layout-bottom menu
...
//                });
        ...
        //Bottom menu with title
        btnBottomMenuWithTitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                BottomMenu.show(me, new String[]{"Menu 1", "Menu 2", "Menu 3"}, new OnMenuItemClickListener() {
                    @Override
                    public void onClick(String text, int index) {
                        toast("Clicked：" + text);
                    }
                }).setTitle("Here is the title text");
            }
        });
        ...
        btnShareDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (DialogSettings.style == DialogSettings.STYLE.STYLE_IOS) {
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_email_ios, "mail"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_qq_ios, "QQ"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_wechat_ios, "WeChat"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_weibo_ios, "Weibo"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_memorandum_ios, "Add to \"Memo\""));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_remind_ios, "reminders"));
                } else {
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_email_material, "mail"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_qq_material, "QQ"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_wechat_material, "WeChat"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_weibo_material, "Weibo"));
                    itemList.add(new ShareDialog.Item(me, R.mipmap.img_hangout_material, "Hangouts"));
        ...
        btnNotify.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Notification.show(me, "prompt", "Prompt message", R.mipmap.ico_wechat).setOnNotificationClickListener(new OnNotificationClickListener() {
                    @Override
                    public void onClick() {
                        MessageDialog.show(me, "prompt", "Clicked the message");
                    }
                }).setOnDismissListener(new OnDismissListener() {
                    @Override
                    public void onDismiss() {
                        log("The news slipped away");
                    }
                });
            }
        });
        ...
        btnMessageDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MessageDialog.show(me, "prompt", "This is a message", "determine");
            }
        });
        ...
        btnSelectDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MessageDialog.show(me, "prompt", "This is a message", "Ok", "Cancel", "cancel")
        ...
        btnInputDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                InputDialog.build(me)
                        ...
                        .setTitle("prompt")
                        .setMessage("Please enter the password (123456)")
                        .setInputText("111111")
                        .setOkButton("determine", new OnInputDialogButtonClickListener() {
                            @Override
                            public boolean onClick(BaseDialog baseDialog, View v, String inputStr) {
                                if (inputStr.equals("123456")) {
                                    TipDialog.show(me, "success！", TipDialog.TYPE.SUCCESS);
                                    return false;
                                } else {
                                    TipDialog.show(me, "wrong password", TipDialog.TYPE.ERROR);
                                    return true;
                                }
                            }
                        })
        ...
        btnWaitDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WaitDialog.show(me, "Test").setOnBackClickListener(new OnBackClickListener() {
                    @Override
        ...
        //Prompt window after waiting for a while
        btnTipDialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                WaitDialog.show(me, "Please wait...");
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                TipDialog.show(me, "success！", TipDialog.TYPE.SUCCESS).setOnDismissListener(new OnDismissListener() {
                                    @Override
                                    public void onDismiss() {
        ...
        //Modal window (serialization) demo
        btnModalDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MessageDialog.build(me)
                        .setTitle("Tips")
                        .setMessage("Serialization dialog box, that is, modal dialog box, is to pop up multiple dialog boxes at a time through the code and only display one at a time. When one dialog box is closed, the next dialog box will be displayed.")
                        .setOkButton("Understanding", new OnDialogButtonClickListener() {
                            @Override
                            public boolean onClick(BaseDialog baseDialog, View v) {
                                return false;
                            }
                        ...
                        .show();
                MessageDialog.show(me, "More functions", "Click the button on the left to close this dialog box, the callback function provided by Kongzue Dialog can easily help you achieve the judgment function you want", "Click me to close" , "I can't turn it off")
                ...
                MessageDialog.show(me, "Vertical arrangement", "If you are using iOS style or Kongzue style, the buttons here can be arranged vertically to provide more choices", "Not bad", "Something interesting", "And What about it?")
                        .setButtonOrientation(LinearLayout.VERTICAL);
                InputDialog.show(me, "Input dialog", "You can also display only one button, like this", "OK");
                MessageDialog.show(me, "Prompt", "Informative dialog box is not affected by modalization, and can be displayed immediately during the display of this dialog box", "Give me a reminder", "End")
        ...
        //Prevent WindowLeaked crash demo
        btnShowBreak.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MessageDialog.show(me, "prompt", "General AlertDialog will show WindowLeaked error if the attached Activity is finished when it is displayed, but Kongzue Dialog does not have this problem, you can click the button below to start and wait In a few seconds, the Activity will be finished, but you will not encounter any crash problems.", "Start crashing", "Cancel")
                        .setMessageTextInfo(new TextInfo().setGravity(Gravity.LEFT))
                        .setOnOkButtonClickListener(new OnDialogButtonClickListener() {
                            @Override
                            public boolean onClick(BaseDialog baseDialog, View v) {
                                WaitDialog.show(me, "Ready to crash...");
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        runOnUiThread(new Runnable() {
        ...
        //Source code Github library, welcome Star&Fork
